...
```bash
/Users/williamqiu/opt/anaconda3/bin/python3 tests/test_dynamic_landmark_ssl.py
/Users/williamqiu/opt/anaconda3/bin/python3 tests/test_dynamic_landmark_ssl_bridge.py
/Users/williamqiu/opt/anaconda3/bin/python3 tests/test_build_mayo_ssl_cache.py
git diff --check
```
