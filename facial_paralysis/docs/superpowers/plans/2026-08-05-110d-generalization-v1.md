...
- [ ] Reuse or create exactly one owner-only audit salt; record its commitment but never use salted IDs to assign folds.  From the project root run `/Users/williamqiu/opt/anaconda3/bin/python3 scripts/audit_palsynet_identity.py --video-root /Users/williamqiu/Desktop/Harvard/Mayo-Clinic/facial_paralysis/data/external/palsynet/data --bundle-root /Users/williamqiu/Desktop/Harvard/Mayo-Clinic/facial_paralysis/data/external/palsynet/derived/identity_marlin_v1/bundles --bundle-provenance /Users/williamqiu/Desktop/Harvard/Mayo-Clinic/facial_paralysis/data/external/palsynet/derived/identity_marlin_v1/provenance.json --output-root outputs/palsynet_identity_audit/generation --top-pairs 1176` exactly once for the unreviewed generation; the output root is no-overwrite and can never become the reviewed root.
