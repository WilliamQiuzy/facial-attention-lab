...
```bash
python3 tests/test_szu_emodage_adapter.py
python3 tests/test_crema_d_adapter.py
python3 tests/test_youtube_identity_review.py
python3 /workspace/Mayo-Clinic/facial_paralysis/data_acquisition/youtube_collect.py status --as-of 2026-07-19T00:00:00-04:00
git diff --check
```
