...
```bash
python3 facial_paralysis/tests/test_clinical_landmarks.py
```
...
```bash
python3 facial_paralysis/tests/test_clinical_landmarks.py
python3 facial_paralysis/tests/test_action_bundle_landmarks.py
python3 facial_paralysis/tests/test_feature_schema.py
python3 facial_paralysis/tests/test_mayo_landmark_audit.py
python3 facial_paralysis/tests/test_pipeline.py
python3 facial_paralysis/tests/test_temporal_pool.py
```
