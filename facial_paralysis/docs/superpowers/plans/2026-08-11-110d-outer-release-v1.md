...
**Tech Stack:** Python 3.9.12 from `python3`, NumPy, scikit-learn, SHA-256, JSON, fixed group-weighted L2 Logistic Regression, H200 release execution. Bare `python3` is forbidden for experiment execution.
...
- [x] Run `KMP_DUPLICATE_LIB_OK=TRUE python3 tests/test_110d_outer_release_v1.py` and require the expected missing-module failure.
