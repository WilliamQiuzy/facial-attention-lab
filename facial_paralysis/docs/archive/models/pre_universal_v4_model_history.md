# Archived Pre-Universal-v4 Model History

> **ARCHIVED 2026-08-16:** This document preserves the sequence of 110D and
> pre-v4 decisions. It is not the current model specification. Use
> `docs/CURRENT_MODEL.md` and `docs/model_registry.json` for all new work.
