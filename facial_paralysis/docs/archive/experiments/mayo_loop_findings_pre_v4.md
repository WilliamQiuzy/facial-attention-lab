...
> **Archived historical status:** This document predates Universal Clinical
> Router v4. Use `../../CURRENT_MODEL.md` for present-tense model claims; all
> 0.668 “champion” references below describe the earlier web-QWK study.
