...
> **Archived historical draft:** This manuscript analyzes an earlier web-QWK
> model and must not be used for current-model reporting. The sole current model
> is Universal Clinical Router v4; its evidence and non-clinical limits are in
> `../../CURRENT_MODEL.md`. Historical artifact paths below may exist only in Git
> history.
