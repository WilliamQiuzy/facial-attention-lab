...
```bash
python3 tests/test_current_model_contract_v4.py
python3 tests/test_universal_clinical_router_v4.py
python3 tests/test_universal_clinical_router_release_v4.py
python3 tests/test_selective_universal_router_v5_release.py
python3 tests/test_universal_clinical_router_v6_release.py
```
